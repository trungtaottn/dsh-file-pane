...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession, getCwd, themeController, defaultTheme, filePane }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    })())) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "dshfp-tabs", role: "tablist", "aria-label": t?.("dock.openTab") ?? "Open tabs" }, /* @__PURE__ */ React.createElement(
      "div",
      {
        key: "t:files",
        className: "dshfp-tab" + (path === void 0 && !activePluginId ? " on" : ""),
