...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession, getCwd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("style", null, `
        ...
        .dshfp-side{display:flex;flex-direction:column;width:200px;min-width:0;flex:none;overflow:hidden;transition:width .18s ease}
        .dshfp-side.closed{width:30px;position:relative;overflow:visible}
        .dshfp-side-top{display:flex;align-items:center;gap:2px;padding:3px 6px;border-bottom:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.12));flex:none}
        .dshfp-fold{background:none;border:0;color:var(--dsw-alias-label-tertiary,#9aa3b5);cursor:pointer;padding:2px 4px;border-radius:5px;display:inline-flex;align-items:center;flex:none}
        .dshfp-fold:hover{color:var(--dsw-alias-label-primary,#eef1f8);background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.08))}
        .dshfp-tab{position:relative;flex:none;padding:2px 8px;border-radius:5px;color:var(--dsw-alias-label-secondary,#c7ccd9);cursor:pointer;font-size:11.5px;text-transform:uppercase;letter-spacing:.05em}
        .dshfp-tab:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.08))}
        .dshfp-tab[data-on]{color:var(--dsw-alias-state-business-primary,#5b96ff);background:var(--dsw-alias-state-business-primary,rgba(91,150,255,.14))}
        .dshfp-sp{flex:1}
    ...
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-body" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "dshfp-side-top" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "dshfp-fold", title: showTree ? t?.("dock.collapseTree") ?? "Collapse file tree" : t?.("dock.revealTree") ?? "Show file tree", onClick: () => setShowTree((v) => !v) }, showTree ? /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "13", height: "13", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M10 4 6 8l4 4" })) : /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "13", height: "13", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M3 3.5h4v3H3z" }), /* @__PURE__ */ React.createElement("path", { d: "M9 9.5h4v3H9z" }), /* @__PURE__ */ React.createElement("path", { d: "M5 6.5v3M11 6.5v3M5 6.5h6" }))), showTree ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "dshfp-tab", "data-on": !changeView || void 0, role: "button", tabIndex: 0, onClick: () => setChangeView(false) }, t?.("dock.files") ?? "Files"), /* @__PURE__ */ React.createElement("span", { className: "dshfp-tab", "data-on": changeView || void 0, role: "button", tabIndex: 0, onClick: () => setChangeView(true) }, t?.("dock.changes") ?? "Changes"), /* @__PURE__ */ React.createElement("span", { className: "dshfp-sp" })) : null),
      showTree ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-side-content" }, changeView ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-tree dshfp-changes", "aria-label": t?.("dock.changes") ?? "Changes" }, /* @__PURE__ */ React.createElement("div", { className: "dshfp-changes-head" }, t?.("dock.changesHead") ?? "Changes in this session"), changed.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-tree-empty" }, "( none changed yet )") : changed.map((c) => /* @__PURE__ */ React.createElement("button", { type: "button", key: c.path, className: "dshfp-changed-item", onClick: () => {
        setPath(c.path);
        setDiff(true);
        setShowTree(false);
      ...
      } }, /* @__PURE__ */ React.createElement("span", { className: "dshfp-changed-dot", "data-status": c.status }, c.status === "added" ? "A" : "M"), /* @__PURE__ */ React.createElement("span", { className: "nm" }, c.path)))) : /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree", "aria-label": t?.("dock.tree") ?? "File tree" }, /* @__PURE__ */ React.createElement(FileTree, { path: base, onOpen: openFile, activePath: viewPath }))) : treeHover ? /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree dshfp-tree-pop", "aria-label": t?.("dock.tree") ?? "File tree" }, changeView ? changed.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-tree-empty" }, "( none changed yet )") : changed.map((c) => /* @__PURE__ */ React.createElement("button", { type: "button", key: c.path, className: "dshfp-changed-item", onClick: () => {
        setPath(c.path);
        setDiff(true);
        setShowTree(false);
        const sid = effSession;
