...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession, getCwd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-body" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "dshfp-rail" }, /* @__PURE__ */ React.createElement("button", { type: "button", className: "dshfp-act", "data-on": !changeView || void 0, title: t?.("dock.files") ?? "Files", onClick: () => {
        setChangeView(false);
        setShowTree(true);
