...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession, getCwd, themeController, defaultTheme, filePane }) {
  ...
  const openFiles = () => {
    ...
    setShowTree(true);
    setSession(void 0);
    persistDockState({ path: void 0, session: void 0 });
  };
  const navDir = (p) => {
    setPath(p);
    setDiff(false);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-head" }, /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.home") ?? "Files root", onClick: () => {
      ...
      setDiff(false);
      setCommitTarget(null);
    } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M2.5 5.5 8 2.5l5.5 3v6L8 14.5l-5.5-3z" }), /* @__PURE__ */ React.createElement("path", { d: "M8 8.5 13 5.5M8 8.5 3 5.5M8 8.5V14" }))), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.openTab") ?? "Open in new tab", onClick: () => window.open(src, "_blank", "noopener") }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M6.5 9.5 13 3" }), /* @__PURE__ */ React.createElement("path", { d: "M8.5 3H13v4.5" }), /* @__PURE__ */ React.createElement("path", { d: "M13 9v3.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5H7" }))), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.close") ?? "Close pane", onClick: () => toggle(false) }, "\u2715")),
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "dshfp-editor" }, /* @__PURE__ */ React.createElement("div", { className: "dshfp-tabs", role: "tablist", "aria-label": t?.("dock.openTab") ?? "Open tabs" }, /* @__PURE__ */ React.createElement(
      "div",
      {
        key: "t:files",
        className: "dshfp-tab" + (path === void 0 && !activePluginId ? " on" : ""),
        onClick: openFiles,
        title: t?.("dock.files") ?? "Files"
      },
      /* @__PURE__ */ React.createElement("span", { className: "dshfp-tab-nm" }, t?.("dock.files") ?? "Files")
    ), tabs.map((tt) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: tt.id,
