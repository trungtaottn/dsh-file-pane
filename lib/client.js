...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout }) {
  ...
  if (!open) return null;
  const src = "/browser/?path=" + (path === void 0 ? "" : encodeURIComponent(path)) + "&embed=1";
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("style", null, `
      ...
      `),
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-head" }, /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.home") ?? "Files root", onClick: () => nav(void 0) }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M2.5 7 8 2.5 13.5 7" }), /* @__PURE__ */ React.createElement("path", { d: "M4 6.5V13h8V6.5" }))), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.up") ?? "Up one level", disabled: !path, onClick: () => nav(upPath(path)) }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M3 10.5 8 5.5l5 5" }))), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.reload") ?? "Reload", onClick: () => setStamp((s) => s + 1) }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M13 3.5V7h-3.5" }), /* @__PURE__ */ React.createElement("path", { d: "M3 12.5V9h3.5" }), /* @__PURE__ */ React.createElement("path", { d: "M13 7a5 5 0 0 0-8.5-3.5L3 5M13 9l-1.5 1.5A5 5 0 0 1 3 7" }))), /* @__PURE__ */ React.createElement("span", { className: "t" }, t?.("dock.title") ?? "Files", path !== void 0 ? ` \xB7 ${name2}` : ""), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.openTab") ?? "Open in new tab", onClick: () => window.open(src, "_blank", "noopener") }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M6.5 9.5 13 3" }), /* @__PURE__ */ React.createElement("path", { d: "M8.5 3H13v4.5" }), /* @__PURE__ */ React.createElement("path", { d: "M13 9v3.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5H7" }))), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.close") ?? "Close pane", onClick: () => toggle(false) }, "\u2715")),
    /* @__PURE__ */ React.createElement("iframe", { key: path + ":" + stamp, src, title: t?.("dock.title") ?? "File pane" })
  );
}
