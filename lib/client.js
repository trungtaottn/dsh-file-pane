...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("style", null, `
      ...
      `),
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-head" }, /* @__PURE__ */ React.createElement("span", { className: "t" }, t?.("dock.title") ?? "Files", path !== void 0 ? ` \xB7 ${name2}` : ""), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.openTab") ?? "Open in new tab", onClick: () => window.open(src, "_blank", "noopener") }, "\u2197"), /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.close") ?? "Close", onClick: () => toggle(false) }, "\u2715")),
    /* @__PURE__ */ React.createElement("iframe", { key: src, src, title: t?.("dock.title") ?? "File pane" })
  );
}
