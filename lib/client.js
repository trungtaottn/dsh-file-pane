...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession, getCwd }) {
  ...
  const [changedOpen, setChangedOpen] = (0, import_react.useState)(false);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    changedOpen ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-changed", "aria-label": t?.("dock.changed") ?? "Files changed this session" }, changed.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-tree-empty" }, "( none changed yet )") : changed.map((c) => /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        key: c.path,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-body" }, showTree ? /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree", "aria-label": t?.("dock.tree") ?? "File tree" }, /* @__PURE__ */ React.createElement(FileTree, { path: base, onOpen: openFile, activePath: viewPath })) : /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      treeHover ? /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree dshfp-tree-popup", "aria-label": t?.("dock.tree") ?? "File tree" }, /* @__PURE__ */ React.createElement(FileTree, { path: base, onOpen: openFile, activePath: viewPath })) : null
