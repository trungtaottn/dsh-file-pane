...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession, getCwd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-body" }, showTree ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-side" }, /* @__PURE__ */ React.createElement("div", { className: "dshfp-side-tabs" }, /* @__PURE__ */ React.createElement("button", { type: "button", "data-on": !changeView || void 0, onClick: () => setChangeView(false) }, t?.("dock.files") ?? "Files"), /* @__PURE__ */ React.createElement("button", { type: "button", "data-on": changeView || void 0, onClick: () => setChangeView(true) }, t?.("dock.changes") ?? "Changes")), changeView ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-tree dshfp-changes", "aria-label": t?.("dock.changes") ?? "Changes" }, /* @__PURE__ */ React.createElement("div", { className: "dshfp-changes-head" }, t?.("dock.changesHead") ?? "Changes in this session"), changed.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-tree-empty" }, "( none changed yet )") : changed.map((c) => /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        key: c.path,
      ...
      /* @__PURE__ */ React.createElement("span", { className: "dshfp-changed-dot", "data-status": c.status }, c.status === "added" ? "A" : "M"),
      /* @__PURE__ */ React.createElement("span", { className: "nm" }, c.path)
    ))) : /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree", "aria-label": t?.("dock.tree") ?? "File tree" }, /* @__PURE__ */ React.createElement(FileTree, { path: base, onOpen: openFile, activePath: viewPath })), /* @__PURE__ */ React.createElement("div", { className: "dshfp-side-foot" }, /* @__PURE__ */ React.createElement("button", { type: "button", title: t?.("dock.collapseTree") ?? "Collapse file tree", onClick: () => setShowTree(false) }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "13", height: "13", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M6 4l4 4-4 4" }), /* @__PURE__ */ React.createElement("path", { d: "M10 4l4 4-4 4" }))))) : /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("button", { type: "button", className: "dshfp-tree-reveal", title: t?.("dock.revealTree") ?? "Show file tree", onClick: () => setShowTree(true) }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("path", { d: "M3 3.5h4v3H3z" }), /* @__PURE__ */ React.createElement("path", { d: "M9 9.5h4v3H9z" }), /* @__PURE__ */ React.createElement("path", { d: "M5 6.5v3M11 6.5v3M5 6.5h6" }))),
      treeHover ? /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree dshfp-tree-popup", "aria-label": t?.("dock.tree") ?? "File tree" }, changeView ? changed.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "dshfp-tree-empty" }, "( none changed yet )") : changed.map((c) => /* @__PURE__ */ React.createElement("button", { type: "button", key: c.path, className: "dshfp-changed-item", onClick: () => {
        setPath(c.path);
        setDiff(true);
        setShowTree(false);
        const sid = effSession;
