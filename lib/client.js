...
function FileTree({ path, onOpen, depth = 0 }) {
  ...
  return /* @__PURE__ */ React.createElement("ul", { className: "dshfp-tree-l", style: { paddingLeft: depth * 12 } }, /* @__PURE__ */ React.createElement("li", { className: "dshfp-tree-row" }, /* @__PURE__ */ React.createElement("button", { className: "dshfp-tree-node", type: "button", onClick: toggle, "data-dir": "1" }, /* @__PURE__ */ React.createElement("span", { className: "chev" }, open ? "\u2304" : "\u203A"), /* @__PURE__ */ React.createElement("span", { className: "nm" }, depth === 0 ? "workspace" : basename(path))), open ? /* @__PURE__ */ React.createElement("ul", { className: "dshfp-tree-c" }, err ? /* @__PURE__ */ React.createElement("li", { className: "dshfp-tree-empty" }, "( failed to load )") : null, rows === null && !err ? /* @__PURE__ */ React.createElement("li", { className: "dshfp-tree-empty" }, "( loading\u2026 )") : null, (rows ?? []).map((e) => {
    ...
    if (e.dir) return /* @__PURE__ */ React.createElement(FileTree, { key: childPath, path: childPath, onOpen, depth: depth + 1 });
    return /* @__PURE__ */ React.createElement("li", { key: childPath, className: "dshfp-tree-row" }, /* @__PURE__ */ React.createElement("button", { className: "dshfp-tree-node", type: "button", "data-file": "1", onClick: () => onOpen(childPath) }, /* @__PURE__ */ React.createElement("span", { className: "chev" }, "\xB7"), /* @__PURE__ */ React.createElement("span", { className: "nm" }, e.name)));
...
function DockRoot({ t, useSessions: _useSessions, useWorkspaces: _useWorkspaces, layout, getSession }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const read = () => {
      setFloating(el.getBoundingClientRect().width === 0);
    };
    read();
  ...
  const needSessionNote = diff && isTextPath(path) && effSession === void 0;
  const name2 = path === void 0 ? "files root" : basename(path);
  const nav = (next) => {
    setPath(next);
  };
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "dshfp-dock-body" }, showTree ? /* @__PURE__ */ React.createElement("nav", { className: "dshfp-dock-tree", "aria-label": t?.("dock.tree") ?? "File tree" }, /* @__PURE__ */ React.createElement(FileTree, { path: void 0, onOpen: (p) => {
      setPath(p);
      setDiff(false);
    } })) : null, /* @__PURE__ */ React.createElement("iframe", { key: path + ":" + diff + ":" + stamp, src, title: t?.("dock.title") ?? "File pane" }))
  );
}
